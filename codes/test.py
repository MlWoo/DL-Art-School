...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-opt", type=str, help="Path to options YAML file.", default="../options/test_diffusion_unet.yml"
    )
    ...
    for test_loader in test_loaders:
        ...
        # log
        logger.info(
            "# Validation # Fea: {:.4e}, PSNR: {:.4e}".format(fea_loss / len(test_loader), psnr_loss / len(test_loader))
        )
