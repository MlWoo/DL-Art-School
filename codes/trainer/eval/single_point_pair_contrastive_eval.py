...
class SinglePointPairContrastiveEval(evaluator.Evaluator):
    def __init__(self, model, opt_eval, env):
        ...
        self.similar_set = DataLoader(
            ImagePairWithCorrespondingPointsDataset(opt_eval["similar_set_args"]),
            shuffle=False,
            batch_size=self.batch_sz,
        )
        self.dissimilar_set = DataLoader(
            ImagePairWithCorrespondingPointsDataset(opt_eval["dissimilar_set_args"]),
            shuffle=False,
            batch_size=self.batch_sz,
        )
    ...
    def perform_eval(self):
        ...
        with torch.no_grad():
            ...
            print(
                f"Eval done. val_similar_lq: {similars.item()}; val_dissimilar_l2: {dissimilars.item()}; val_diff: {diff}"  # noqa: E501
            )
        self.model.train()
...
#     eval = SinglePointPairContrastiveEval(
#         model,
#         {
#             "batch_size": 8,
#             "quantity": 32,
#             "similar_set_args": {"path": "E:\\4k6k\\datasets\\ns_images\\segformer_validation\\similar", "size": 256},
#             "dissimilar_set_args": {
