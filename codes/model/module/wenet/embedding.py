...
from modelaudio.module.wenet.rope_utils import precompute_freqs_cis
...
class RopePositionalEncoding(PositionalEncoding):
    ...
    def __init__(self, d_model: int, head_dim: int, dropout_rate: float, max_len: int = 1500, rope_theta=10000.0):
